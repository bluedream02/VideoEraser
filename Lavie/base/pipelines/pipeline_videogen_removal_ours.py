...
class VideoGenPipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        super().__init__()
        concept: Optional[str] = 'Claude Monet'
    ...
    def concept(self):
        r"""
        Getter method for the concept used

        Returns:
            `str`:
            The text describing the concept
        """
        return self._concept_text

    @concept.setter
    def concept(self, concept):
        r"""
        Setter method for the concept used

        Args:
            concept (`str`):
                The text of the new concept
        """
        self._concept_text = concept
        ...
        **kwargs,
        ...
        if do_classifier_free_guidance:
            ...
            if True:
                ...
                # Here we concatenate the unconditional and text embeddings into a single batch
                # to avoid doing two forward passes
                prompt_embeds = torch.cat([uncond_embeddings, prompt_embeds, concept_embeddings])
