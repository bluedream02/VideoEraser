...
if __name__ == "__main__":
    ...
    parser.add_argument("--unsafe_concept", type=str, required=True, 
                        help="The type of unsafe concept") #, choices=('porn', 'racism', 'violence', 'terrorism', 'animal abuse'))

    parser.add_argument("--image_or_video_path", type=str, default=None,
                        help="The path of the image to be used as the background of the video")
    parser.add_argument("--model_path", type=str, default="/nas-hdd/shoubin/pretrained_model/CogVideoX-5b/",
    ...
    parser.add_argument("--part", type=int, default=0, help="The seed for reproducibility")
